...
const typeConfig: Record<string, { glyph: IconType; bg: string; color: string; label: string; tone: 'mint' | 'amber' | 'violet' | 'rose' }> = {
  commande: { glyph: Store01Icon, bg: 'bg-[#e7faf2]', color: 'text-[#278e69]', label: 'Vente', tone: 'mint' },
  paiement: { glyph: Wallet01Icon, bg: 'bg-[#e7faf2]', color: 'text-[#278e69]', label: 'Paiement', tone: 'mint' },
  campagne: { glyph: Chart02Icon, bg: 'bg-[#efedff]', color: 'text-[#5b49e8]', label: 'Campagne', tone: 'violet' },
  vendeur: { glyph: Share02Icon, bg: 'bg-[#efedff]', color: 'text-[#5b49e8]', label: 'Partage', tone: 'violet' },
  fraude: { glyph: GiftIcon, bg: 'bg-[#fff4de]', color: 'text-[#ac741e]', label: 'Récompense', tone: 'amber' },
  systeme: { glyph: CheckmarkCircle02Icon, bg: 'bg-[#f0eff5]', color: 'text-[#67627b]', label: 'Système', tone: 'amber' },
};
